#ifndef __PCILinuxDeviceIdentifier
#define __PCILinuxDeviceIdentifier
...
*
*
*     @short The DeviceIdentifier for the PCILinuxBusAdapter.
*            
*            The  class   contains  data   which  is  needed   by  the 
*            PCILinuxBusAdapter to perform configuration space accesses.
...
class PCILinuxDeviceIdentifier : public PCIDeviceIdentifier {
public :

  PCILinuxDeviceIdentifier( xpci::Address deviceConfigAddress,
			   bool swapFlag = false);
...
//   */
  ...
  uint32_t getPCIBusAddress( uint32_t iBar ) const 
    throw (BusAdapterException);
...
#endif /* __PCILinuxDeviceIdentifier */
