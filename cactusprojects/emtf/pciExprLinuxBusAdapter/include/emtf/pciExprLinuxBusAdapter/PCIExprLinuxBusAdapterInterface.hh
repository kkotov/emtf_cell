#ifndef __PCIExprLinuxBusAdapterInterface
#define __PCIExprLinuxBusAdapterInterface
...
*            
*            The PCIExprLinuxBusAdapterInterface is  the software interface for
...
*            
*            Every PCIDevice has  a handle to a PCIExprLinuxBusAdapterInterface
...
class PCIExprLinuxBusAdapterInterface {
public :

  /**
   * Virtual destructor of the class.
   */
  virtual ~PCIExprLinuxBusAdapterInterface() {};
...
#endif /* __PCIExprLinuxBusAdapterInterface */
