...
InputCscPortIds InputCscPortIds::instance; // create the only instance of the class

InputCscPortIds::InputCscPortIds() :
    ids({
        // endcap 1, sector 1
...
{
    // the body of the constructor of InputCscPortIds
}
