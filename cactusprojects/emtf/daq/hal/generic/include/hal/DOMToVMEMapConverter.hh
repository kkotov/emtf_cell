#ifndef __DOMToVMEMapConverter
#define __DOMToVMEMapConverter
...
*
*       @see VMEAddressTableXMLFileReader
...
public:
   ...
   * This routine is used by the VMEAddressTableXMLFileReader. Since 
